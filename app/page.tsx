          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-xl p-8">
            ...
            <div className="mb-8">
              <button
                ...
                className="w-full bg-blue-600 hover:bg-blue-700 text-white font-bold py-4 px-6 rounded-lg flex items-center justify-center gap-3 transition-colors"
              >
            ...
            <div className="relative mb-6">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="px-4 bg-white dark:bg-gray-800 text-gray-500">Or connect manually</span>
              </div>
            </div>
            ...
            {emails.length === 0 ? (
              <div className="text-center py-12">
                ...
                <p className="text-gray-600 dark:text-gray-400">
                  No emails to display yet. Click "Connect with Gmail" to fetch your emails.
                </p>
              </div>
            ) : (
